            ...
            },
            {
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton${row.id}">
                        <a class="dropdown-item" href="${row.empresasEdit}">Editar - ${row.nome}</a>
                        <a class="dropdown-item delete-btn" href="#" data-url="${row.empresasExclud}" data-id="${row.id}">Deletar - ${row.nome}</a>
                    </div>
                </div>
                `;
                },
